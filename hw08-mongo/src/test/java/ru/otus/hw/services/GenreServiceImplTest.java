...
public class GenreServiceImplTest {
    ...
    void shouldInsertGenre() {
        // Arrange
        long genreId = 1;
        String genreName = "Genre_1";
        var expectedGenre = new Genre(genreId, genreName);
        Mockito.when(sequenceGeneratorService.getNext(Genre.SEQUENCE_NAME)).thenReturn(genreId);

        // Act
        var author = genreService.insert(genreName);
