...
public class GenreControllerTest {
    ...
    void shouldReturnCorrectGenreListForUser() throws Exception {
        long genreId1 = 1;
    ...
    void shouldDenyGenreListForNonPermittedUser() throws Exception {
        mvc.perform(get("/genres"))
    ...
    @Test
    @WithMockUser(authorities = {"ROLE_USER"})
    void shouldDenyCreationGenreForGeneralUser() throws Exception {
